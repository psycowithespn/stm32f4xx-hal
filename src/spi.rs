...
#[cfg(feature = "stm32f412")]
use gpio::gpioa::{PA1, PA5, PA6, PA7, PA10, PA11, PA12};

#[cfg(any(feature = "stm32f401", feature = "stm32f407", feature = "stm32f429"))]
use gpio::gpiob::{PB3, PB4, PB5, PB10, PB13, PB14, PB15};

#[cfg(feature = "stm32f412")]
use gpio::gpiob::{PB0, PB3, PB4, PB5, PB8, PB10, PB12, PB13, PB14, PB15};

#[cfg(any(feature = "stm32f401", feature = "stm32f407", feature = "stm32f429"))]
use gpio::gpioc::{PC2, PC3, PC10, PC11, PC12};

#[cfg(feature = "stm32f412")]
use gpio::gpioc::{PC2, PC3, PC7, PC10, PC11, PC12};

#[cfg(any(feature = "stm32f401", feature = "stm32f412", feature = "stm32f429"))]
use gpio::gpiod::{PD3, PD6};

#[cfg(any(feature = "stm32f401", feature = "stm32f412", feature = "stm32f429"))]
use gpio::gpioe::{PE2, PE5, PE6, PE12, PE13, PE14};

#[cfg(feature = "stm32f429")]
use gpio::gpiof::{PF7, PF8, PF9, PF11};
...
#[cfg(feature = "stm32f412")]
use gpio::{AF5, AF6, AF7, Alternate};
